...
![Профилировщики приложений: инструментирование (диагностические точки во всех функциях) и сэмплирование (периодические прерывания и сбор информации)](assets/lec-application-profilers-instrumentation-sampling.png)
