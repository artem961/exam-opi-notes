...
![Рецепты при высоком %IO wait: оптимизация запросов к диску, согласование блоков с ОС, буфера/кэши, аппаратура (SSD/flash-кэш)](assets/lec-recipes-high-iowait.png)
