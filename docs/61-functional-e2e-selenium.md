...
![Функциональное тестирование: на базе сценариев использования, средства автоматизации Selenium, Sahi, Watir](assets/lec-functional-e2e-testing-selenium-scenarios.png)
